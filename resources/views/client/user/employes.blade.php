...
@section('content')
    <!-- page title -->
    <x-page-title title="{{ __('Liste des employés') }}" pagetitle="Employés" />
                        ...
                        <table class="w-full border-separate table-custom border-spacing-y-1 whitespace-nowrap">
                            ...
                            <tbody class="list">
                                @forelse ($members as $member)
                                    @if ($member->client_approved_at && $member->client_approved_at != '')
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto px-6 py-8">
                ...
                <div class="mt-5 text-center">
                    ...
                    <div class="flex justify-center gap-2 mt-6">
                        ...
                        <form action="{{--! route('candidates.destroy', $member->id) --}}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
