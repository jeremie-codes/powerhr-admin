...
<body class="text-gray-800 text-sm">
    ...
    <div class="p8 gap-6 pages">
        ...
        <!-- Left -->
        <div class="bg-red-500" style="width: 39%; float: left; height: 100%; position: relative;">
            <div class="bg-red-50 pr-2" style="position: absolute; top: 0; right: 0; width: 80%; height: 100%; padding-left: 20px;">
                <!-- profil -->
                ...
                <!-- Coordonnée -->
                <div>
                    <h2 class="text-lg font-semibold text-red-500 pb-4 border-b border-gray-300 my-4">Informations <br> Personnelles</h2>
                ...
                <!-- Compétences -->
                <div>
                    <h2 class="text-lg font-semibold text-red-500 pb-4 border-b border-gray-300 my-4">Compétences</h2>
                ...
                <!-- langue parléé -->
                <div>
                    <h2 class="text-lg font-semibold text-red-500 pb-4 border-b border-gray-300 my-4">Langue parlées</h2>
                    <ul class="list-disc list-inside text-sm space-y-1">
                        @if ($cv->langue)
