...
Route::domain('powehr.site')->group(function () {
    Route::get("/", [RouteController::class, 'index'])->name('pages.index');
});

Route::domain('admin.powehr.site')->group(function () {
...
Route::domain('client.powehr.site')->group(function () {
...
Route::domain('candidat.powehr.site')->group(function () {
